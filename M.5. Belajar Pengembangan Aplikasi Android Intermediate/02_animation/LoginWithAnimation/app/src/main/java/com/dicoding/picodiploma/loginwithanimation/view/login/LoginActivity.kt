...
class LoginActivity : AppCompatActivity() {
    ...
    private fun playAnimation() {
        val imageAnim = ObjectAnimator.ofFloat(binding.imageView, View.TRANSLATION_X, -30f, 30f)
            .apply {
                duration = 6000
        ...
        val buttonAnim = login

        imageAnim.start()
        AnimatorSet().apply {
            playSequentially(titleAnim, emailAnim, passwordAnim, buttonAnim)
        }.start()
    }
}