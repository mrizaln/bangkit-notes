...
object ImageFileHelper {
    private const val STREAM_LENGTH_LIMIT = 1_000_000
    private const val DOWNSCALE_TRIES_LIMIT = 3
    ...
    suspend fun reduceImageSize(file: File): File? {
        ...
        Log.d(
            "ImageFileHelper",
            "reduceImageSize begin (len: $streamLength, %: ${100 * (streamLength / STREAM_LENGTH_LIMIT.toDouble()).toInt()})"
        )
