...
//    ListAdapter<Student, StudentListAdapter.WordViewHolder>(WordsComparator()) {      // <<< original
    PagedListAdapter<Student, StudentListAdapter.WordViewHolder>(WordsComparator()) {        // Paging2
