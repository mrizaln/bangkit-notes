...
data class StudentAndUniversity(
    ...
    @Relation(
        parentColumn = "univId", entityColumn = "universityId"
    )
...
data class UniversityAndStudent(
    ...
    @Relation(
        parentColumn = "universityId", entityColumn = "univId"
    )
...
data class StudentWithCourse(
    ...
    @Relation(
        ...
        associateBy = Junction(
            value = CourseStudentCrossRef::class, parentColumn = "sId", entityColumn = "cId"
        )
    )
