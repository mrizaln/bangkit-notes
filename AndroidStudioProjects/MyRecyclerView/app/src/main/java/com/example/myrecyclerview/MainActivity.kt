...
class MainActivity : AppCompatActivity() {
    ...
    private var layoutOption = R.id.action_list
...
//        val dataPhoto: TypedArray = resources.obtainTypedArray(R.array.data_photo)
